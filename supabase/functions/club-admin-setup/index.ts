...
async function ensureDefaultUsecaseAcl(clubId: string) {
  const defaults: Array<{
    ...
    { role_key: "member", usecase_key: "members", can_view: false, can_read: false, can_write: false, can_update: false, can_delete: false },
    ...
    { role_key: "vorstand", usecase_key: "members", can_view: true, can_read: true, can_write: true, can_update: true, can_delete: false },
    ...
    { role_key: "admin", usecase_key: "members", can_view: true, can_read: true, can_write: true, can_update: true, can_delete: true },
