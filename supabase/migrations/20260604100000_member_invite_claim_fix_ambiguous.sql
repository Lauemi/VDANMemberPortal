-- member_invite_claim: club_id/club_member_id kollidierten mit OUT-Spalten → OUT umbenannt (out_*),
-- Profil-UPDATE-Spalten mit Alias p. qualifiziert. Deployed via Supabase-MCP 2026-06-04, repo-wahr.
...
begin
  ...
  if not v_has_prof then
    ...
    update public.profiles p set
      ...
      canonical_membership_id = coalesce(p.canonical_membership_id, v_inv.club_member_id),
